...
export namespace DIARandomOracleTypes {
  ...
  export interface CallMethodTable {
    ...
    setRandomValue: {
      params: CallContractParams<{ round: bigint; value: DIARandomValue }>;
      result: CallContractResult<null>;
    };
  }
...
> {
  ...
  tests = {
    ...
    setRandomValue: async (
      params: TestContractParams<
        DIARandomOracleTypes.Fields,
        { round: bigint; value: DIARandomValue },
        { randomValues?: Map<bigint, DIARandomValue> }
      >
    ): Promise<
      TestContractResult<null, { randomValues?: Map<bigint, DIARandomValue> }>
...
export const DIARandomOracle = new Factory(
  Contract.fromJson(
    ...
    "=24-1=1+7=293-1+e=78+7a7e0214696e73657274206174206d617020706174683a2000=40",
    "decff945d3df57dc1909bd9f0728cdec7dbe71a90c3e8c2de16b97edd9482a09",
    AllStructs
  )
);
