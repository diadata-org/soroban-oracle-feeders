...
type FixedLengthArray<T, L extends number, R extends T[] = []> = R['length'] extends L ? R : FixedLengthArray<T, L, [T, ...R]>;

export const fillArray = <T>(inputArray: T[], desiredSize: number, fillItem: T): FixedLengthArray<T, 10> => {
